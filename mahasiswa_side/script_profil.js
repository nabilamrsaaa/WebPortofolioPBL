...
if (!elements.simpanBtn || !elements.formSection) {
    console.error("Beberapa elemen penting tidak ditemukan! Periksa kembali ID di HTML Anda.");
...
const dataProdi = {
  "Teknik Informatika": [
    "D3 Teknik Informatika", "D4 Rekayasa Keamanan Siber", "D4 Rekayasa Perangkat Lunak",
    "D4 Teknologi Rekayasa Multimedia", "D4 Teknologi Rekayasa Sistem Elektronika",
    "S2 Terapan Teknologi Rekayasa Perangkat Lunak"
  ],
  "Teknik Elektro": [
    "D3 Elektronika", "D4 Teknik Elektronika", "D4 Teknologi Rekayasa Internet of Things (IoT)",
    "D4 Teknologi Rekayasa Sistem Elektronika"
  ],
  "Teknik Mesin": [
    "D3 Teknik Mesin", "D4 Teknologi Rekayasa Manufaktur", "D4 Teknologi Rekayasa Mekatronika",
    "D4 Teknologi Rekayasa Pengelasan"
  ],
  "Manajemen dan Bisnis": [
    "D3 Akuntansi", "D3 Administrasi Bisnis", "D4 Akuntansi Manajerial",
    "D4 Logistik Bisnis", "D4 Manajemen Rekayasa"
  ]
};
...
function populateProdiDropdown(selectedJurusan) {
  elements.prodi.innerHTML = '<option value="">-- Pilih Program Studi --</option>';
...
elements.btnUnggah.addEventListener("click", () => elements.uploadInput.click());
elements.uploadInput.addEventListener("change", () => handlePhotoUpload(elements.uploadInput.files[0]));
